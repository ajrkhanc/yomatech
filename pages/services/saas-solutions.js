...
export default function GeneralStaffing() {
    ...
    return (
      <>
        ...
        <section class="hero-section-two bgs-cover overlay pt-80 rpt-80 saassolutionsbg">
        <div class="container">
            <div class="row">
        ...
        <section className="services-section-two boxccsp pb-30 pt-50">
        ...
        <section className="about-section pt-50 pb-20 saasdarkbg">
            <div className="container">
                <div className="row align-items-center">                    
                    ...
                    <div className="col-lg-6">
                        ...
                        <img src="/assets/img/saas-solution2.png" alt="About"/>
                        </div>
                    </div>
                </div>
            </div>
               ...
               <div className="container">
                  <div className="row">
                     <div className="col-sm-6 coleql1">
                         ...
                         <div className="section-title text-left mb-0">
                            <h2 className="mainh1"><span>Payroll </span>solutions</h2> 
                             ...
                             <h5>What we manage in payroll:</h5>
                             <ul className="list-style-three mt-15">
                     ...
                     <div className="col-sm-6 coleql2">
                         <div>
                         <img src="/assets/img/payroll-m.png" alt="About"/>                          
                         </div>
                     </div>
                  </div>
               </div>
        ...
        <section className="about-section pt-10 pb-30">
            <div className="container">
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6">
                        <div className="wow fadeInLeft delay-0-2s animated animateleft text-center">
                        <img src="/assets/img/hrm2.jpg" alt="About"/>
                        </div>
                    </div>
                </div>
            </div>
